    ...
    return (
      ...
      >
        ...
        <input
          ...
          type="number"
          className="bg-[var(--surface)] lg:w-[300px] w-3/4 no-spinner placeholder:text-sm h-fit focus:outline-none focus:border-[var(--border)] border-1 border-[var(--muted)] rounded-sm px-2 py-1 text-[var(--text)] "
        />
